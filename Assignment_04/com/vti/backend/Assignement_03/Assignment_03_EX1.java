...
public class Assignment_03_EX1 {
    public static void main(String[] args) {
        ...
        Khởi tạo Lương của com.vti.entity.Assignment_01.Account 1 là 5240.5 $
        Khởi tạo Lương của com.vti.entity.Assignment_01.Account 2 là 10970.055$
        Khai báo 1 số int để làm tròn Lương của com.vti.entity.Assignment_01.Account 1 và in số int đó ra
        Khai báo 1 số int để làm tròn Lương của com.vti.entity.Assignment_01.Account 2 và in số int đó ra   */
     ...
     /*   com.vti.entity.Assignment_01.Question 2:
        ...
        Lấy 2 số cuối của số ở com.vti.entity.Assignment_01.Question 2 và in ra.
        Gợi ý:
