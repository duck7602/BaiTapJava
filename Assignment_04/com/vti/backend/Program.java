...
//    table (giống trong Database)
    ...
    public static void get_infor_exam(Exam exam) {
        ...
        System.out.println("com.vti.entity.Exam ID: " + exam.getExamId());
...
/*    com.vti.entity.Question 2
    ...
    public static void get_account(Account acc) {
        System.out.println("com.vti.entity.Account ID: " + acc.getAccountId());
        System.out.println("Email: " + acc.getEmail());
        System.out.println("Username: " + acc.getUserName());
        System.out.println("Full Name: " + acc.getFullName());
        System.out.println("com.vti.entity.Department: " + acc.getDepartmentId().getDepartmentName());
        System.out.println("com.vti.entity.Position: " + acc.getPositionId().getPositionName());
