package com.vti.entity.Assignment_01;/*Table 3: com.vti.entity.Assignment_01.Account
...
public class Account {
  ...
  /*  com.vti.entity.Assignment_01.Question 2:
    Tạo constructor cho com.vti.entity.Assignment_01.Account:
    ...
    và com.vti.entity.Assignment_01.Position của User, default createDate = now
    d) Có các parameter là id, Email, Username, FirstName, LastName (với FullName = FirstName + LastName)
    và com.vti.entity.Assignment_01.Position của User, createDate.
