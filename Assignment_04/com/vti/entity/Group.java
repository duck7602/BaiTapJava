package com.vti.entity;/*Table 4: com.vti.entity.Group
...
public class Group {
    ...
    Tạo constructor cho com.vti.entity.Group:
    a) Không có parameters
    b) Có các parameter là GroupName, Creator, array com.vti.entity.Account[] accounts, CreateDate
    c) Có các parameter là GroupName, Creator, array String[] usernames , CreateDate
    Với mỗi username thì sẽ khởi tạo 1 com.vti.entity.Account (chỉ có thông tin username, các thông tin còn lại = null).
