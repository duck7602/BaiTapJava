...
public class Program {
    public static void main(String[] args) {
        ...
        System.out.println("Department 1: " + saleDepartment);
        System.out.println("Department 2 (Name): " + marketingDepartment.departmentName + "\n");
        ...
        System.out.println("Position 1: " + devPosition + "\n");
...
/*    Question 2
    ...
    In ra Exam đã tạo ngày nào theo định dạng:
    ...
    public static void get_account(Account acc) {
        ...
        System.out.println("Department: " + acc.departmentId.departmentName);
        System.out.println("Position: " + acc.positionId.positionName);
